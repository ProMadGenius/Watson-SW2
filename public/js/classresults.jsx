    ...
    return (<tr className="base--tr">
      <td className="base--td" colSpan="2">
        ...
        <div className="correctForm">
          <h3 className="iscorrect base--h3">¿Es correcta la información?</h3>
          <div className="correctButtons">
            <button className={this.state.selected === 'yes' ? 'selected' : 'unselected'} onClick={this.handleClick.bind(this,'yes')}>Si</button>
            <button className={this.state.selected === 'maybe' ? 'selected' : 'unselected'} onClick={this.handleClick.bind(this,'maybe')}>Puede ser shi</button>
...
class WowFormInputForm extends React.Component {
  ...
  render() {
    ...
    return (<tr style={baseStyle} className="base--tr">
      ...
      <label><em className="base--em">¿Estuvo impresionante? :v</em></label>
    ...
    if (this.props.items && this.props.items.length === 0) {
      if (this.props.faceCount === 0 && this.props.wordCount === 0) {
        return (<div className="use--mismatch">
          La puntuación de esta imagen no está por encima del umbral de 0,5</div>);
      } else {
    ...
    return (
        <div className="results-table--container">
          ...
          <table className="base--table results-table">
            ...
            <tr className="base--tr">
              <th colSpan="2" className="base--th">Jerarquía de tipos</th>
            </tr></tbody>
            <tbody className="base--tbody">
    ...
    if (this.props.items && this.props.items.length == 0) {
      return (
          <table className="base--table results-table">
            ...
            <tr className="base--tr">
              <td className="base--td" colSpan="2">
                <p>La puntuación de esta imagen no está por encima del umbral de 0.5 en base a los datos de formación proporcionados.</p>
              </td>
            </tr>
            </tbody>
            <tbody className="base--tbody">
...
class WordsScoreTable extends React.Component {
  render() {
    return (
        <div className="results-table--container">
          <div className="beta-tag">En beta</div>
          <div>Aun esta a prueba incluso en Watson. Experimental</div>
          <JsonLink rawjson={this.props.rawjson}/>
          <table className="base--table results-table">
            <ScoreTableHeader title={this.props.category}/>
            <tbody className="base--tbody">
